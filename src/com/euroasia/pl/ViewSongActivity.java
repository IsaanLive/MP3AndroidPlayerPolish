...
public class ViewSongActivity extends Activity implements OnTouchListener, OnCompletionListener, OnBufferingUpdateListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
	    ...
	    if (mediafile.exists()) {
	    	...
	    	download.setText("Utwór został już pobrany");
		}
		...
		protected Void doInBackground(Void... arg0) {
			...
			String searchResult = httpRun("http://search.azlyrics.com/search.php?q="+searchQuery).toString();
			 if(searchResult.equals("")){
				 fail = 1;
				lyrics = "Nie udało się załadować tekstu"; 
				return null;
			 }
	...
	class ProgressTask extends AsyncTask<Integer, Integer, Void>{
		  ...
		  protected void onProgressUpdate(Integer integers) {
			  if(integers == 1) {
			    Toast.makeText(ViewSongActivity.this, "Utwór jest buforowany", Toast.LENGTH_SHORT).show(); 
			  }
		  }
