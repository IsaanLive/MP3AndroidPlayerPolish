...
import com.euroasia.pl.R;
import com.euroasia.pl.DownloadingActivity;
...
public class DownloadService extends Service {
	...
	public class DownloadFilesTask  extends AsyncTask<String, Void, Void> {
		...
		protected void onCancelled() {
			...
			regularNotif("Anulowano pobieranie","Anulowano: "+filename,filename); 
		...
		protected void onPostExecute(Void result) {
			...
			if(fail == 1){
				regularNotif("Pobieranie zakończone niepowodzeniem","Nieudane: "+filename,filename); 
				http--;
				...
				regularNotif("Zakończono pobieranie","Ukończone: "+filename,filename); 
			}
		...
		public void ongoingNotif(String contentTitle, String tickerText, String contentText ){
			...
			notification.setLatestEventInfo(context, contentTitle, "Kliknij, by sprawdzić postępy", contentIntent);
			notificationManager.notify(numberd+9, notification);
		}
